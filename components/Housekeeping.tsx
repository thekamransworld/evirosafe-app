...
import { checklistTemplates } from '../data';
...
export const Housekeeping: React.FC = () => {
    ...
    const { checklistRunList, setChecklistRunList, projects } = useDataContext();

    const [isRunModalOpen, setRunModalOpen] = useState(false);
    const [isDetailModalOpen, setDetailModalOpen] = useState(false);
    const [selectedTemplate, setSelectedTemplate] = useState<ChecklistTemplate | null>(null);

    const housekeepingTemplates = useMemo(() => checklistTemplates.filter(t => t.category === 'Housekeeping'), []);
