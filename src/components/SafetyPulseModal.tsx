                ...
                <div className="p-4 border-b dark:border-dark-border flex-shrink-0">
                    <div className="flex justify-between items-center">
                         <div className="flex items-center space-x-2">
                             ...
                             <select className="p-1 border rounded-md text-sm bg-transparent dark:bg-dark-background dark:border-dark-border"><option>All Areas</option></select>
                             <select className="p-1 border rounded-md text-sm bg-transparent dark:bg-dark-background dark:border-dark-border"><option>All Contractors</option></select>
                         </div>
                         <div className="flex items-center space-x-2">
