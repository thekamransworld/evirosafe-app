            ...
            <main className="flex-1 p-6 overflow-y-auto">
              ...
              <div className={activeTab === 'details' ? '' : 'hidden'}>
                ...
                <div className="grid grid-cols-2 gap-x-6 mt-4">
                    ...
                    {/* Cost Impact Section */}
                    <Section title="Cost Impact Analysis" fullWidth>
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                <h5 className="font-semibold mb-1">Direct Costs</h5>
                                <p>Medical: ${costs.directCosts.medical}</p>
                                <p>Repair: ${costs.directCosts.repair}</p>
                                <p>Fines: ${costs.directCosts.fines}</p>
                            </div>
                            <div>
                                <h5 className="font-semibold mb-1">Indirect Costs</h5>
                                <p>Downtime: ${costs.indirectCosts.downtime}</p>
                                <p>Lost Productivity: ${costs.indirectCosts.lostProductivity}</p>
                            </div>
                        </div>
                        <div className="mt-2 pt-2 border-t dark:border-gray-700 font-bold">
                            Total Estimated: ${costs.totalEstimated}
                        </div>
                    </Section>
                </div>
              </div>
