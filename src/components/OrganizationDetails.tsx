...
import { 
  ...
  MoreVertical, Mail, Phone, MapPin, Globe 
} from 'lucide-react';
...
const InviteUserModal: React.FC<InviteUserModalProps> = ({ isOpen, onClose, orgId }) => {
    ...
    // Filter projects for this specific organization
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-4">
                <div className="h-16 w-16 rounded-xl bg-white p-1 shadow-md">
                    <img src={org.branding.logoUrl} alt={org.name} className="h-full w-full object-contain rounded-lg" />
                </div>
                <div>
