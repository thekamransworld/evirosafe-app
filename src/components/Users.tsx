...
// ... (Keep InviteUserModal and ReassignModal as they are) ...
// I will just provide the main Users component part to save space, 
// but ensure you keep the modals if you copy-paste. 
// Actually, to be safe, I will provide the FULL file content below.
