...
export const ptwTypeDetails: Record<PtwType, { icon: string; description: string; color: string; hex: string; }> = {
    ...
    'Mechanical Work': { icon: '⚙️', description: 'Mechanical maintenance', color: 'gray-500', hex: '#6B7280' },
    'Chemical Handling': { icon: '🧪', description: 'Hazardous substances', color: 'green-500', hex: '#10B981' },
};

export const ptwChecklistData: Record<PtwType, Omit<PtwSafetyRequirement, 'response' | 'is_critical' | 'evidence_urls' | 'comment'>[]> = {
    ...
    'Electrical Work': [{ id: 'ew_1', text: 'LOTO applied' }],
    'Excavation': [{ id: 'ex_1', text: 'Underground services scanned' }],
    'Lifting': [{ id: 'li_1', text: 'Lifting plan approved' }],
    'Confined Space Entry': [{ id: 'cs_1', text: 'Gas test conducted' }],
    'Night Work': [{ id: 'nw_1', text: 'Adequate lighting provided' }],
    'Road Closure': [{ id: 'rc_1', text: 'Traffic management plan approved' }],
    'Utility Work': [{ id: 'uw_1', text: 'Service clearance obtained' }],
    'Mechanical Work': [{ id: 'mw_1', text: 'Equipment isolated' }],
    'Chemical Handling': [{ id: 'ch_1', text: 'MSDS available' }],
};
